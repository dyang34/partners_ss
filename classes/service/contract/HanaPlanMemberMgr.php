...
class HanaPlanMemberMgr extends A_Mgr
{
    ...
    function getByKey($key) {
        ...
        try {
            ...
            $row = HanaPlanMemberDao::getInstance()->selectByKey($db, $key);
    ...
    function getFirst($wq) {
        ...
        try {
            ...
            $row = HanaPlanMemberDao::getInstance()->selectFirst($db, $wq);
    ...
    function getList($wq) {
        ...
        try {
            ...
            $result = HanaPlanMemberDao::getInstance()->select($db, $wq);
    ...
    function getListPerPage($wq, $pg) {
        ...
        try {
            ...
            $pg->setTotalCount(HanaPlanMemberDao::getInstance()->selectCount($db, $wq));
            $result = HanaPlanMemberDao::getInstance()->selectPerPage($db, $wq, $pg);
    ...
    function getCount($wq) {
        ...
        try {
            ...
            $result = HanaPlanMemberDao::getInstance()->selectCount($db, $wq);
    ...
    function exists($wq) {
        ...
        try {
            ...
            $result = HanaPlanMemberDao::getInstance()->exists($db, $wq);
    ...
    function edit($uq, $key) {
        ...
        try {
            ...
            $isOk = HanaPlanMemberDao::getInstance()->update($db, $uq, $key);
    ...
    function delete($key) {
        ...
        try {
            ...
            $isOk = HanaPlanMemberDao::getInstance()->delete($db, $key);
