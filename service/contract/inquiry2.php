...
<form name="pageForm" method="get">
    ...
    <div class="check-box-wrap">
        <div class="search-shnch-wrap">
            ...
            <form name="searchForm" method="get" action="inquiry2.php">
                <input type="hidden" name="_order_by" value="<?=$_order_by?>">
                <input type="hidden" name="_order_by_asc" value="<?=$_order_by_asc?>">
...
if ($rs->num_rows > 0) {
    for($i=0; $i<$rs->num_rows; $i++) {
        ...
        $link_url = "inquiry2_view.php?hana_plan_no=".$row["no"];
...
*/?>                                
                        ...
                        <tr>
                            <td><a href="<?=$link_url?>"><?=$row["manager_name"]?></a></td><!-- 담당자 -->
