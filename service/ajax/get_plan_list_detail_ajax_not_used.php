...
$plan_type = RequestUtil::getParam("plan_type","");
if(empty($company_type) || empty($member_no) || empty($trip_type) || empty($plan_type)) {
	$rtnVal['RESULTCD'] = "901";
...
$rtnVal['LIST'] = $__ARR_CONFIG_PLAN[$company_type]['List'][$member_no][$trip_type][$plan_type];
echo json_encode($rtnVal);
exit;
?>