...
?>
            ...
            <!-- 1페이지 start -->
            <div class="section engInteg english">
                <div>
                    <div class="title">
...
?>
                                ...
                                <tr>
                                    <td><?=!empty($__ARR_CONFIG_PLAN_TYPE[$__CONFIG_COMPANY_TYPE][$__CONFIG_MEMBER_NO][$trip_type]["type_".$k]["title_eng"])?$__ARR_CONFIG_PLAN_TYPE[$__CONFIG_COMPANY_TYPE][$__CONFIG_MEMBER_NO][$trip_type]["type_".$k]["title_eng"]:$__ARR_CONFIG_PLAN_TYPE[$__CONFIG_COMPANY_TYPE][$__CONFIG_MEMBER_NO][$trip_type]["type_".$k]["title"]?></td>
...
?>
                        ...
                        <div class="text-bottom-wrap">
                            <p>- For Detailed conditions such as Claims covered or not covered by the insurance company, please refer to the policy clauses.</p>
                        </div>
                    </div>
                </div>
