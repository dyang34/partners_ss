            ...
            <div class="modal-cont">
				...
				<div class="cont-wrap">
					<ul class="ban-wrap">
						...
						<li>부르키나파소, 부룬디, 콩고(자이레), 중앙아프리카, 콩고, 기니, 리비아, 말리, 수단, 시에라리온, 소말리아, 챠드, 자이레</li>
						...
						<li>
							<p>남극</p>
							<p class="type-dash">* 외교부의 여행금지대상 국가정보는 수시로 변경됩니다.<br/>
								여행금지대상국가의 경우 가입이 불가하거나 또는 보상 대상에서 제외될 수 있습니다.<br/>
								외교부 해외안전여행 2단계까지 가입이 가능합니다. 그 외 지역은 연락바랍니다.</p>
