...
require_once $_SERVER['DOCUMENT_ROOT']."/classes/service/plan/PlanCodePriceLongTermMgr.php";

$company_type = RequestUtil::getParam("company_type", "");
$p_member_no = RequestUtil::getParam("member_no", "");
$member_no = "";

for($i_trip_type=1;$i_trip_type<=2;$i_trip_type++) {
	...
	*/
	...
	$wq->addAndString("trip_type","=",$i_trip_type);
	...
	$file_name = $_SERVER['DOCUMENT_ROOT']."/config/"."plan_price_boundary_list_".$i_trip_type;
	...
	$file_name = $_SERVER['DOCUMENT_ROOT']."/config/"."plan_price_list_".$i_trip_type;
...
$rs = PlanCodePriceLongTermMgr::getInstance()->getListTermDay($wq);
...
$rs = PlanCodePriceLongTermMgr::getInstance()->getList($wq);
